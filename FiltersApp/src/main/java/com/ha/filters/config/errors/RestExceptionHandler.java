...
import static com.ha.filters.config.errors.ErrorConstants.ERROR_CLIENT_EXCEPTION;
import static com.ha.filters.config.errors.ErrorConstants.ERROR_DATA_INTEGRITY_ERROR;
import static com.ha.filters.config.errors.ErrorConstants.ERROR_DATE_TIME_PARSE_EXCEPTION;
import static com.ha.filters.config.errors.ErrorConstants.ERROR_EMPTY_RESULT_DATA_ACCESS;
import static com.ha.filters.config.errors.ErrorConstants.ERROR_INTERNAL_SERVER_ERROR;
import static com.ha.filters.config.errors.ErrorConstants.ERROR_REST_CLIENT_EXCEPTION;
import static com.ha.filters.config.errors.ErrorConstants.ERROR_TIMEOUT;
import static com.ha.filters.config.filter.MdcLoggingFilter.TRANSACTION_ID;
...
public class RestExceptionHandler {
  ...
  @ExceptionHandler({
      FiltersAppRestClientException.class,
  ...
  public ResponseEntity<Object> restClientException(Exception ex) {
    ...
    if (ex instanceof FiltersAppRestClientException) {
      restError.setErrorCode(((FiltersAppRestClientException) ex).getCode() != null ? ((FiltersAppRestClientException) ex).getCode() : ERROR_REST_CLIENT_EXCEPTION);
    } else {
